...
//Licença MIT: Permite uso livre deste código inclusive para fins comerciais, sem pagar nada
...
contract FloodHelp {
    ...
    function openRequest (string memory title, string memory description,string memory contact, uint goal) public {
        ...
        function closeRequest(uint id) public {
            ...
            require(requests[id].open && (msg.sender==author || balance >= goal), unicode"Voce não pode fechar este pedido");
